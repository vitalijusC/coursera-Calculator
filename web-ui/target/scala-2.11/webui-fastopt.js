...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var ref = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$1, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var array = [((-$uD(b$1.apply__O())) / (2 * $uD(a$2.apply__O())))];
        if (($uI(array.length) === 0)) {
          ...
          while ((i < len)) {
            ...
            b$2.$$plus$eq__O__scm_SetBuilder(arg1);
            i = ((1 + i) | 0)
          };
          var jsx$1 = b$2.elems$1
        };
        return $as_sci_Set(jsx$1)
      } else {
        var jsx$2 = $uD(b$1.apply__O());
        var a$1 = $uD(delta$1.apply__O());
        var x1 = (((-jsx$2) + $uD($g.Math.sqrt(a$1))) / (2 * $uD(a$2.apply__O())));
        var jsx$3 = $uD(b$1.apply__O());
        var a$3 = $uD(delta$1.apply__O());
        var x2 = (((-jsx$3) - $uD($g.Math.sqrt(a$3))) / (2 * $uD(a$2.apply__O())));
        var array$1 = [x1, x2];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  var bv = $uD(b.apply__O());
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, c$1, bv$1) {
    return (function() {
      return ((bv$1 * bv$1) - (4 * ($uD(a$1.apply__O()) * $uD(c$1.apply__O()))))
    })
  })(a, c, bv));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(value) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, value$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(value$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, value));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
